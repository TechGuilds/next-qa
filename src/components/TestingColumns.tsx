...
import styles from './TestingColumns.module.css'

const TestingColumns = (props) => {
  return (
...
TestingColumns.defaultProps = {
  rootClassName: '',
  fields: {},
}

TestingColumns.propTypes = {
  rootClassName: PropTypes.string,
  fields: PropTypes.object,
}

export default TestingColumns
