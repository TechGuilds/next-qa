...
import styles from './FixesTestComponent.module.css'

const FixesTestComponent = (props) => {
  return (
...
FixesTestComponent.defaultProps = {
  rootClassName: '',
  fields: {},
}

FixesTestComponent.propTypes = {
  rootClassName: PropTypes.string,
  fields: PropTypes.object,
}

export default FixesTestComponent
