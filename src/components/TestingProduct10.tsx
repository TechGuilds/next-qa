...
import styles from './TestingProduct10.module.css'

const TestingProduct10 = (props) => {
  return (
...
TestingProduct10.defaultProps = {
  rootClassName: '',
  fields: {},
}

TestingProduct10.propTypes = {
  rootClassName: PropTypes.string,
  fields: PropTypes.object,
}

export default TestingProduct10
