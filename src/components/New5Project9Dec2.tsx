...
import styles from './New5Project9Dec2.module.css'

const New5Project9Dec2 = (props) => {
  return (
...
New5Project9Dec2.defaultProps = {
  rootClassName: '',
  fields: {},
}

New5Project9Dec2.propTypes = {
  rootClassName: PropTypes.string,
  fields: PropTypes.object,
}

export default New5Project9Dec2
