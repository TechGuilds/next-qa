...
import styles from './TestProductsRecommendations.module.css'

const TestProductsRecommendations = (props) => {
  return (
...
TestProductsRecommendations.defaultProps = {
  rootClassName: '',
  fields: {},
}

TestProductsRecommendations.propTypes = {
  rootClassName: PropTypes.string,
  fields: PropTypes.object,
}

export default TestProductsRecommendations
