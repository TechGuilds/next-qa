...
import styles from './RepeatKjoFirst.module.css'

const RepeatKjoFirst = (props) => {
  return (
...
RepeatKjoFirst.defaultProps = {
  rootClassName: '',
  fields: {},
}

RepeatKjoFirst.propTypes = {
  rootClassName: PropTypes.string,
  fields: PropTypes.object,
}

export default RepeatKjoFirst
