    ...
    >
      ...
      <Container tag="div" className={styles['container']}>
        <button
          ...
          aria-expanded="false"
          className={styles['html-element02']}
        >
        ...
        <Container tag="div" id="headerSearch" className={styles['container1']}>
          <button
            ...
            aria-controls="headerSearch"
            aria-expanded="false"
            className={styles['html-element03']}
          >
          ...
          <label
            id="lblSearch"
            htmlFor="sbquery"
            className={styles['html-element04']}
          >
          ...
          <Container tag="div" className={styles['container2']}>
            ...
            <input
              ...
              type="hidden"
              value
              className={styles['html-element08']}
            />
          </Container>
          <button type="submit" className={styles['html-element09']}>
