...
import styles from './ThisIsANewComponent.module.css'

const ThisIsANewComponent = (props) => {
  return (
...
ThisIsANewComponent.defaultProps = {
  rootClassName: '',
  fields: {},
}

ThisIsANewComponent.propTypes = {
  rootClassName: PropTypes.string,
  fields: PropTypes.object,
}

export default ThisIsANewComponent
