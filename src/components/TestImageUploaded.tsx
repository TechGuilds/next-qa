...
import styles from './TestImageUploaded.module.css'

const TestImageUploaded = (props) => {
  return (
...
TestImageUploaded.defaultProps = {
  rootClassName: '',
  fields: {},
}

TestImageUploaded.propTypes = {
  rootClassName: PropTypes.string,
  fields: PropTypes.object,
}

export default TestImageUploaded
