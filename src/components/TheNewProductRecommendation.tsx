...
import styles from './TheNewProductRecommendation.module.css'

const TheNewProductRecommendation = (props) => {
  return (
...
TheNewProductRecommendation.defaultProps = {
  rootClassName: '',
  fields: {},
}

TheNewProductRecommendation.propTypes = {
  rootClassName: PropTypes.string,
  fields: PropTypes.object,
}

export default TheNewProductRecommendation
