...
import styles from './AppleIPhoneBlack.module.css'

const AppleIPhoneBlack = (props) => {
  return (
    <Container>
...
AppleIPhoneBlack.defaultProps = {
  fields: {},
}

AppleIPhoneBlack.propTypes = {
  fields: PropTypes.object,
}

export default AppleIPhoneBlack
