...
import styles from './ZProductRecommendation.module.css'

const ZProductRecommendation = (props) => {
  return (
...
ZProductRecommendation.defaultProps = {
  rootClassName: '',
  fields: {},
}

ZProductRecommendation.propTypes = {
  rootClassName: PropTypes.string,
  fields: PropTypes.object,
}

export default ZProductRecommendation
