...
import styles from './Nov2422ThreeColumnPromo.module.css'

const Nov2422ThreeColumnPromo = (props) => {
  return (
...
Nov2422ThreeColumnPromo.defaultProps = {
  rootClassName: '',
  fields: {},
}

Nov2422ThreeColumnPromo.propTypes = {
  rootClassName: PropTypes.string,
  fields: PropTypes.object,
}

export default Nov2422ThreeColumnPromo
