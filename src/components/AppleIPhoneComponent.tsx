...
import styles from './AppleIPhoneComponent.module.css'

const AppleIPhoneComponent = (props) => {
  return (
    <Container>
      <Container bgImage className={styles['container']}>
        ...
        >
          ...
          >
            ...
            >
              <Text text={props.fields.text5} className={styles['text3']} />
              <Container
...
AppleIPhoneComponent.defaultProps = {
  fields: {},
}

AppleIPhoneComponent.propTypes = {
  fields: PropTypes.object,
}

export default AppleIPhoneComponent
