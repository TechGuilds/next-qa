...
import styles from './AppleIPhoneBlack3.module.css'

const AppleIPhoneBlack3 = (props) => {
  return (
    <Container>
...
AppleIPhoneBlack3.defaultProps = {
  fields: {},
}

AppleIPhoneBlack3.propTypes = {
  fields: PropTypes.object,
}

export default AppleIPhoneBlack3
