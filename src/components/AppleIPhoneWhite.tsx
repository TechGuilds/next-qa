...
import styles from './AppleIPhoneWhite.module.css'

const AppleIPhoneWhite = (props) => {
  return (
    <Container>
...
AppleIPhoneWhite.defaultProps = {
  fields: {},
}

AppleIPhoneWhite.propTypes = {
  fields: PropTypes.object,
}

export default AppleIPhoneWhite
