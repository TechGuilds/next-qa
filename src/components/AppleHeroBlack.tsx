...
import styles from './AppleHeroBlack.module.css'

const AppleHeroBlack = (props) => {
  return (
...
AppleHeroBlack.defaultProps = {
  rootClassName: '',
  fields: {},
}

AppleHeroBlack.propTypes = {
  rootClassName: PropTypes.string,
  fields: PropTypes.object,
}

export default AppleHeroBlack
