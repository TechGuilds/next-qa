...
const AppComponent = (props) => {
  return (
    <Container className={`app-component-container ${props.rootClassName} ${props.params?.styles} `}>
      <Container className="app-component-row-container container-default">
        <Text text={props.fields.description} className="text-default" />
      </Container>
    </Container>
  )
}
